...
#	echo " ------- Sun JDK 1.4 -------"
	...
	echo -e "\033[1m   21)\033[0m  Sun JDK 1.6.0 Update 37 64Bit\033[0m "
        echo -e "\033[1m   22)\033[0m  Sun JDK 1.6.0 23 64Bit"
        echo -e "\033[1m   23)\033[0m  Sun JDK 1.6.0 24 64Bit"
        echo -e "\033[1m   24)\033[0m  Sun JDK 1.6.0 25 64Bit"
        echo -e "\033[1m   25)\033[0m  Sun JDK 1.6.0 26 64Bit"
        echo -e "\033[1m   26)\033[0m  Sun JDK 1.6.0 27 64Bit"
        echo -e "\033[1m   27)\033[0m  Sun JDK 1.6.0 30 64Bit"
	...
	echo -e "\033[1m   65) Latest: IBM JDK 1.7 64Bit SR5\033[0m"	
...
# --------------------------------   Sun 1.6 
		...
		22) JAVA_HOME=/export/utils/java/jdk1.6.0_23-64Bit;;
		23) JAVA_HOME=/export/utils/java/jdk1.6.0_24-64Bit;;
		24) JAVA_HOME=/export/utils/java/jdk1.6.0_25-64Bit;;
		25) JAVA_HOME=/export/utils/java/jdk1.6.0_26-64Bit;;
		26) JAVA_HOME=/export/utils/java/jdk1.6.0_27-64Bit;;
		27) JAVA_HOME=/export/utils/java/jdk1.6.0_30-64Bit;;
		28) JAVA_HOME=/export/utils/java/jdk1.6.0_39-64Bit;;
# --------------------------------   Sun 7.0
...
# --------------------------------   IBM 1.7
		65|67) JAVA_HOME=/export/utils/java/java-ibm1.7-x86_64-70-SR5;;
