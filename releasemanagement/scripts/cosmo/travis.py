...
travis_repos=['cloudify-rest-client','cloudify-dsl-parser','cloudify-plugins-common','cloudify-cli','cloudify-manager','cloudify-bash-plugin','cloudify-openstack-provider','cloudify-chef-plugin','cloudify-fabric-plugin','cloudify-openstack-plugin','cloudify-script-plugin']
