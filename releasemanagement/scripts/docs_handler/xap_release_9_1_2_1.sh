...
XAP_RELEASE_VERSION_FOLDER=${API_DOC_VERSION}.2.1
MILESTONE=ga
BUILD_NUM=7920
...
cp ${XAP_RELEASE_DOWNLOAD_DIR}/${MAJOR_VERSION}/${XAP_RELEASE_VERSION_FOLDER}/${XAP_ZIP_FILENAME} ${DOC_DIR}
...
cp  ${XAP_RELEASE_DOWNLOAD_DIR}/${MAJOR_VERSION}/${XAP_RELEASE_VERSION_FOLDER}/${DOTNET_HELP_FILE} ${DOTNET_DOCS_DIR}
